...
SELECT * FROM turnos_medicos.pacientes;

SELECT * FROM turnos_medicos.turnos;

SELECT * FROM turnos_medicos.log_turnos;

SELECT * FROM turnos_medicos.auditoria_pacientes;

SELECT * FROM turnos_medicos.vista_turnos_activos;

call turnos_medicos.crear_turno(6, 4, '2025-07-21', '10:00:00');
